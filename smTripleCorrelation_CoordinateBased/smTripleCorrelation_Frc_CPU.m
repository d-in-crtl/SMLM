function [Correlation, rho_center, rad_center] = smTripleCorrelation_Frc_CPU(coor_1, coor_2, coor_3, roiszx, roiszy, MaxRhoSize, rho_res, rad_res)
...
for ii = 1 : size(coor_1_inner, 1)
    ...
    thresh_3 = mean(thresh_3_tmp(:)) + 5 * std(thresh_3_tmp(:)); 
    thresh_2 = mean(thresh_2_tmp(:)) + 5 * std(thresh_2_tmp(:));
