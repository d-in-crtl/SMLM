function [bins, Norm, PairCorrelation] = smPairCorrelation_GPU(coor_1, coor_2, roiszx, roiszy)
...
[bins, Norm, corr] = smPairCorrGPU(x_1, y_1, x_2, y_2, roiszx, roiszy);

Norm = (reshape(Norm, [], size(coor_1, 1)))';
corr = reshape(corr, 64, []);
PairCorrelation = sum(corr, 2);
