...
clc
fclose('all');
addpath('C:\Users\RothenbergLab\Documents\Visual Studio 2015\Projects\MATLAB\sCMOS\PxPairCorrelation');

ColorMode = 'RGB'; % the autocorrelation will be calculated for all the colors specified here;
